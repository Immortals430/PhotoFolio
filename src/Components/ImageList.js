...
function ImageList(props) {
  ...
  async function deleteImage(id, title, url) {
    ...
    const updateData = existingImageArray
      .map((value) => {
        ...
        <section>
          ...
          {!hide ? (
            <div className="flex hcenter form">
              <h4>
                Add Image of {props.imageList.albumName}
                {/* {props.album[props.imageList].albumName} */}{" "}
              </h4>
              ...
              <div className="flex vcenter imageLsit-input-container">
                ...
                <button
                  onClick={() => {
                    props.addImage(titleRef, urlRef);
                    emptyInput();
                  }}
                >
                  Add
          ...
          {updateForm.state ? (
            <div className="flex hcenter upDateForm">
              ...
              <button
                onClick={() => {
                  edit(props.imageList.id, updateTitleRef, updateUrlRef);
                }}
              >
                Update
              </button>
                ...
                return value.title && value.url ? (
                  <div className="card-wrapper" key={i}>
                    <div
                      ...
                      className="card flex"
                      style={{
                        background: `url(${value.url}) center`,
                    ...
                    >
                      ...
                      ></div>
                      <a className="download" href={value.url} download>
                        <i className="fa-solid fa-download"></i>
                      </a>
                      <span
                        className="edit"
                        onClick={() => toggleUpdateForm(value.title, value.url)}
                      >
