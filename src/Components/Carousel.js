      ...
      props.fireStoreData.map((value, i) => {
        if (value.id === props.carouselData.albumId) {
          value.image.map((value, index) => {
            if (
              value.title === props.carouselData.title &&
              props.carouselData.url === value.url
            ) {
    ...
    <>
      <div className="carousel-background flex vcenter hcenter">
        <div className="image">
          ...
          <span
            className="prev flex hcenter vcenter"
            onClick={() => navigate(-1)}
          >
            <i className="fa-solid fa-chevron-left"></i>
          </span>
          <span
            className="next flex hcenter vcenter"
            onClick={() => navigate(1)}
          >
        ...
        <div
          ...
          onClick={() => props.carouselStateToggle(false)}
        >
