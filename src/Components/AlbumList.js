            ...
            <div className="flex hcenter form">
              ...
              <div className="flex ">
                <div className="input">
                  ...
                  <span onClick={emptyInput} className="flex vcenter ">
                    <i className="fa-solid fa-circle-xmark"></i>
                  </span>
                </div>
                <button
                  onClick={() => {
                    props.createAlbum(createAlbumInputRef);
                    emptyInput();
                  }}
                >
                  Create
              ...
              <div className="card-wrapper" key={i}>
                <div
                  ...
                  style={
                    value.image[0].url
                      ? {
                          background: `url(${value.image[0].url}) center`,
                ...
                >
                  <div
                    ...
                    onClick={() =>
                      props.renderImageList(value.id, value.albumName)
                    }
                  ></div>
                  <span
                    className="delete"
